...
<div class="container">
			...
			<header>
				<h1>Online Library Management System <span>STUDENT DETAILS FOR UPDATION</span></h1>
            </header>       
				<div  class="main">
					<?php 
					...
					?>
						<tr>
							...
							<td><a class="search" href="update.php?class=<?php echo $class; ?>&update_id=<?php echo base64_encode($res['id']); ?>">Update</a></td>
						</tr>
						<?php } ?>
					</table>
					<br>
					...
					<br>
						<h2><a href="select-class.php?page=update" >Go to Select Class</a></h2><br/>
				</div> 
